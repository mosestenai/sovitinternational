...
import stylessss from "./partners.module.css";
    ...
    return (
        <div onWheel={event => {
            ...
            <div className={styles.homebody}>
                ...
                <div className={stylessss.firstdivhow}>
                ...
                <div className={width < 780 ? stylessss.bottomhomediv : styles.bottomhomediv} ref={ref2}>
                    <div className={width < 780 ? stylessss.bottomdivimageswrap : styles.bottomdivimageswrap}  >
                        <div className={stylessss.wrapmaxresdefault2}>
                            <img src={require("../assets/radio.png")} className={stylessss.maxresdefault2} />
                            <div className={stylessss.howitworks}>
                                <div className={stylessss.imagebuttondescription}>RADIO ROOFTOP</div>
                                <div className={stylessss.morebutton}>MORE</div>
                            </div>
                        </div>
                        <div className={stylessss.wrapmaxresdefault2}>
                            <img src={require("../assets/terazza.png")} className={stylessss.maxresdefault2} />
                            <div className={stylessss.howitworks}>
                                <div className={stylessss.imagebuttondescription}>TERRAZZA TRIENALE</div>
                                <div className={stylessss.morebutton}>MORE</div>
                            </div>
                        </div>
                        <div className={stylessss.wrapmaxresdefault2}>
                            <img src={require("../assets/caffe.png")} className={stylessss.maxresdefault2} />
                            <div className={stylessss.howitworks}>
                                <div className={stylessss.imagebuttondescription}>CAFFE NAPOLI</div>
                                <div className={stylessss.morebutton}>MORE</div>
                            </div>
                        </div>
                    </div>
